...
export const APP_CONTENT: AppConfigType = {
  ...
  announcementContent: [
    ...
    State of the Map 2026 — Calls for Participation now open! Share your talks, workshops, and ideas with the global OpenStreetMap community. 👉
    <a href="https://2026.stateofthemap.org/calls/general/" target="_blank" rel="noopener noreferrer" class="underline font-bold">Submit your proposal</a>
    <span class="inline-block align-middle mx-2"> <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="3" cy="3" r="3" fill="#50683c"/>
    </svg>
    </span>Talks, workshops, panels & lightning talks welcome
    <span class="inline-block align-middle mx-2"> <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="3" cy="3" r="3" fill="#50683c"/>
    </svg>
    </span>Connect with mappers, developers & researchers worldwide
    <span class="inline-block align-middle mx-2"> <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="3" cy="3" r="3" fill="#50683c"/>
    </svg>
    </span>Shape the future of open mapping
    <span class="inline-block align-middle mx-2"> <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="3" cy="3" r="3" fill="#50683c"/>
    </svg>
    </span>First-time speakers encouraged!
    <span class="inline-block align-middle mx-2"> <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="3" cy="3" r="3" fill="#50683c"/>
    </svg>
    </span>Don't miss the biggest OSM event of the year —
    <a href="https://2026.stateofthemap.org/calls/general/" target="_blank" rel="noopener noreferrer" class="underline font-bold">Submit now</a>
    `,
  ],
  EXPLORE_OSM: {
    title: "Explore OSM",
