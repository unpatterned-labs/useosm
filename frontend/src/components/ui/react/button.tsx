...
export interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: "primary" | "secondary" | "tertiary" | "outline" |"navlink" |"navlinkHovered";
  size?: "sm" | "md" | "lg";
  href?: string;
  id: string;
  disabled?: boolean;
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    navlink: "bg-transparent text-inherit hover:bg-white-3 hover:text-neutral-200 disabled:text-neutral-disabled disabled:bg-surface-elevated",
    navlinkHovered: "bg-transparent text-inherit bg-white-3 text-neutral-200 disabled:text-neutral-disabled disabled:bg-surface-elevated"
  };
