...
const OSMStatsSlider = ({
  ...
  return (
    <div className="relative flex w-full flex-col items-center gap-y-8">
      ...
      <div
        className={`border-grey-50 text-grey-400 pointer-events-none absolute top-1 flex h-10 w-16 cursor-pointer items-center justify-center rounded-4xl border bg-white text-base font-medium shadow-xl transition-transform duration-150`}
        style={{
          left: thumbLeft,
      ...
      <input
        ...
        className="bg-grey-50 ring-white-2 focus:outline-white-2 h-3 w-full cursor-pointer appearance-none rounded-4xl ring-4 [&::-moz-range-thumb]:size-8 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-none [&::-webkit-slider-thumb]:size-8 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-none"
      />
      ...
      {[
        ...
        <div className="flex flex-col gap-y-6" key={`osm-stat-${id}`}>
          <div className="flex items-center gap-x-2">
            <div className="flex size-8 items-center justify-center rounded-full bg-green-300 p-1 md:size-12 md:p-2">
