  ...
  return (
    <div className="relative flex w-full flex-col items-center gap-y-8">
      ...
      <input
        ...
        className="bg-grey-50 ring-white-2 focus:outline-white-2 h-3 w-full cursor-pointer appearance-none rounded-4xl ring-4 [&::-moz-range-thumb]:size-10 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:bg-none [&::-webkit-slider-thumb]:size-10 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:bg-none"
      />
